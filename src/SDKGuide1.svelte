<script>
    ...
    import Code1 from "./sdkguide1/code1.svelte"
    import Code2 from "./sdkguide1/code2.svelte"
    import Code3 from "./sdkguide1/code3.svelte"
    import Code4 from "./sdkguide1/code4.svelte"
...
<div class='title mg-top'>딥 링크 이벤트 분석</div>
딥 링크가 오픈되는 시점에 페트리 트래킹 코드를 호출함으로써, 콘솔에서 딥 링크 발생 이벤트에 대한 추적이 가능합니다.
<div class='sub-title-1 no-mgtop'>링크 오픈 시점</div>
